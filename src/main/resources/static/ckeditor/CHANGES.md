...
* Updated [SCAYT](https://ckeditor.com/cke4/addon/scayt) (Spell Check As You Type) and [WebSpellChecker](https://ckeditor.com/cke4/addon/wsc) (WSC) plugins:
	...
	* SCAYT default specNumber of suggested words in the context menu changed to 3.
...
* [#7662](https://dev.ckeditor.com/ticket/7662): [Opera] Fixed: Extra empty specNumber/bullet shown in the editor body when editing a multi-level list [pasted from Word](https://ckeditor.com/cke4/addon/pastefromword).
...
* [#12097](https://dev.ckeditor.com/ticket/12097): Fixed: JAWS not reading the specNumber of options correctly in the [Text Color and Background Color](https://ckeditor.com/cke4/addon/colorbutton) button menu.
