...
//@RestController
//public class AjaxOrderAliController {
//    @Autowired
...
//    public ApiResult<Object> orderPull(@RequestBody DataRow reqData, HttpServletRequest req) throws IOException, InterruptedException {
//        Integer updType = reqData.getInt("updType");//更新类型0拉取新订单1更新订单
//        Integer shopId=1;//阿里巴巴店铺id
//        var shop = service.getShop(shopId);
//
...
//                var pullOrderLog=salesOrderService.getErpOrderPullLogByShopId(shopId,0);
//                if(pullOrderLog!=null){
//                    startTime=pullOrderLog.getEndTime();
//                }else startTime=endTime-60*60*24*7;
//            //更新30天订单
//            }else startTime=endTime-60*60*24*30;
//
//            //第一次获取
//            UpdateAliGoodsResult upResult = updAliOrder(pageIndex, 20, settingEntity.getAccess_token(),startTime,endTime);
...
//
//                UpdateAliGoodsResult upResult1 = updAliOrder(pageIndex, 20, settingEntity.getAccess_token(),startTime,endTime);
//                totalSuccess += upResult1.getTotalSuccess();
//                totalError += upResult1.getTotalError();
//                pageIndex++;
//            }
//            salesOrderService.addErpSalesPullOrderLog(startTime,endTime,shopId,totalSuccess,0,totalError,0);
...
//     * @return
//     */
//    private UpdateAliGoodsResult updAliOrder(Integer pageNo, Integer pageSize, String token,Long startTime,Long endTime) {
//        Integer shopId =1 ;//阿里巴巴shopId
...
//        param.setCreateStartTime(new Date(startTime*1000));
//        param.setCreateEndTime(new Date(endTime*1000));
...
//            orderEntity.setClientName(tradeInfo.getBaseInfo().getBuyerContact().getName());
//            //订单用户实体
