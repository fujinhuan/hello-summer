...
//     * @throws ApiException
//     */
//    @RequestMapping("/tao_ajax/pull_order")
//    @ResponseBody
//    public ApiResult<String> orderPull(@RequestBody TaoRequest req, Model model, HttpServletRequest request) throws ApiException {
//        log.info("/**************主动更新tao订单****************/");
...
//
//        //第一次获取
//        TaoBaoOpenOrderUpdResult<DcTmallOrderEntity> upResult = TaoBaoOpenOrderUpdHelper.updTmallOrder(pageIndex, pageSize, url, appKey, appSecret, sessionKey);
//
...
//
//            TaoBaoOpenOrderUpdResult<DcTmallOrderEntity> upResult1 = TaoBaoOpenOrderUpdHelper.updTmallOrder(pageIndex, pageSize, url, appKey, appSecret, sessionKey);
//            //循环插入订单数据到数据库
...
//     * @throws ApiException
//     */
//    @RequestMapping("/tao_ajax/pull_refund_order")
//    @ResponseBody
