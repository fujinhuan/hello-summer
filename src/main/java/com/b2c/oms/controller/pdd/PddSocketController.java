...
//        System.out.println(JsonUtil.transferToJson(response1));
    ...
    @RequestMapping("/tttt")
    @ResponseBody
    public String pddTest(Model model) throws Exception {
        String clientId = "dc953bcf16d24b27abf3e64a59e1ecd1";
        String clientSecret = "de296599e194a08cbfbb2b3b340e11fec7a1bacc";
        String accessToken = "5f3ed4cddf99491e883bc6dfd867bed3b1ec90a4";
        String accessToken1 = "c99a5f0233e44b93bcf8ebd9cd02313f95c56cf2";
        PopClient client = new PopHttpClient(clientId, clientSecret);
        PddGoodsListGetRequest r = new PddGoodsListGetRequest();
        PddGoodsListGetResponse response = client.syncInvoke(r, accessToken);

        PddGoodsDetailGetRequest informationGetRequest = new PddGoodsDetailGetRequest();
        informationGetRequest.setGoodsId(407690025053L);
        PddGoodsDetailGetResponse pddGoodsDetailGetResponse = client.syncInvoke(informationGetRequest, accessToken);

        PddGoodsCatsGetRequest pddGoodsCatsGetRequest = new PddGoodsCatsGetRequest();
        pddGoodsCatsGetRequest.setParentCatId(0L);
        PddGoodsCatsGetResponse pddGoodsCatsGetResponse = client.syncInvoke(pddGoodsCatsGetRequest, accessToken);
